          ...
          <div>
            ...
            <div className="flex space-x-4">
              {[
                ...
                <a key={social.label} href={social.href} aria-label={social.label} className="text-white/40 hover:text-accent transition-colors">
                  {social.svg}
                </a>
              ))}
            </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                <FontAwesomeIcon icon={faPhone} className="h-4 w-4 text-accent shrink-0" />
                <span className="text-white/70 text-sm">+244 922 717 574 / 935358417</span>
              </div>
              <div className="flex items-center gap-3">
                <FontAwesomeIcon icon={faEnvelope} className="h-4 w-4 text-accent shrink-0" />
                <span className="text-white/70 text-sm">contacts.orbislink@gmail.com</span>
              </div>
              <div className="flex items-start gap-3">
                <FontAwesomeIcon icon={faLocationDot} className="h-4 w-4 text-accent shrink-0 mt-0.5" />
