...
const CATEGORIES = [
  ...
  { id: 'citrus',  label: 'C├¡tricos',   icon: faLemon,         color: '#F4A100' },
  ...
  { id: 'paes',    label: 'P├úes',       icon: faBreadSlice,    color: '#A0522D' },
  { id: 'lacteos', label: 'L├ícteos',    icon: faCheese,        color: '#E5A020' },
...
/* ÔöÇÔöÇÔöÇ Design tokens ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */
const T = {
  /* Greens */
  g900:   '#2c863b',
  g700:   '#1A5C24',
...
/* ÔöÇÔöÇÔöÇ Countries ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */
const COUNTRIES = [
  { code: 'AO', name: 'Angola',              flag: '­ƒçª­ƒç┤', currency: 'Kz'  },
  { code: 'BR', name: 'Brasil',              flag: '­ƒçº­ƒçÀ', currency: 'R$'  },
  { code: 'PT', name: 'Portugal',            flag: '­ƒçÁ­ƒç╣', currency: 'Ôé¼'   },
  { code: 'MZ', name: 'Mo├ºambique',          flag: '­ƒç▓­ƒç┐', currency: 'MT'  },
  { code: 'CV', name: 'Cabo Verde',          flag: '­ƒç¿­ƒç╗', currency: 'CVE' },
  { code: 'ST', name: 'S├úo Tom├® e Pr├¡ncipe', flag: '­ƒç©­ƒç╣', currency: 'Db'  },
  { code: 'GW', name: 'Guin├®-Bissau',        flag: '­ƒç¼­ƒç╝', currency: 'CFA' },
]

/* ÔöÇÔöÇÔöÇ Skeleton ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */
...
/* ÔöÇÔöÇÔöÇ Country selector ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */
...
/* ÔöÇÔöÇÔöÇ Live Ticker ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */
      ...
      <div style={{ flex: 1, overflow: 'hidden', padding: '8px 20px' }}>
        <div style={{ display: 'flex', gap: 32, animation: 'tickerScroll 18s linear infinite' }}>
          {[
            ...
            `${total.toLocaleString('pt-AO')} kg dispon├¡veis`,
            `${engagement} interac├º├Áes`,
            '7 pa├¡ses cobertos',
            'Verifica├º├úo em tempo real',
            'B2B ┬À Directo ┬À Rastre├ível',
          ].concat([
            `${products.length} produtos activos`,
            `${total.toLocaleString('pt-AO')} kg dispon├¡veis`,
            `${engagement} interac├º├Áes`,
            ...
            <span key={i} style={{ fontSize: 11, color: 'rgba(255,255,255,0.55)', whiteSpace: 'nowrap', fontWeight: 500, letterSpacing: '0.02em' }}>
              {item}
              {i < 11 && <span style={{ marginLeft: 32, color: 'rgba(255,255,255,0.18)' }}>Ôùå</span>}
            </span>
          ))}
        </div>
      </div>
...
const AppHome = () => {
  ...
  const filteredProducts = useMemo(() => {
    ...
    return products.filter(p => {
      ...
      const map: Record<string, string[]> = {
        frutas:   ['fruta','manga','banana','abacate','ma├º├ú','maca','anan├ís','ananas','papaia','mam├úo','mamao','pera','uva','melancia','melao','mel├úo'],
        citrus:   ['laranja','lim├úo','limao','tangerina','lima','citrino'],
        legumes:  ['cenoura','batata','beterraba','mandioca','inhame','ab├│bora','abobora','tomate','cebola','alho'],
        verduras: ['alface','couve','espinafre','folha','r├║cula','rucula','agri├úo','agriao','verdura'],
        cereais:  ['milho','arroz','trigo','feij├úo','feijao','soja','aveia','cereal'],
        tempero:  ['pimenta','jindungo','gengibre','tempero','salsa','coentro','manjeric├úo','manjericao'],
        pescado:  ['peixe','pescado','camar├úo','camarao','marisco','bacalhau'],
        carnes:   ['carne','frango','vaca','porco','cabrito'],
        ovos:     ['ovo'],
        paes:     ['p├úo','pao','padaria','biscoito'],
        lacteos:  ['leite','queijo','iogurte','manteiga','l├ícteo','lacteo'],
        bebidas:  ['suco','sumo','bebida','caf├®','cafe','ch├í','cha'],
      }
  ...
  useEffect(() => {
    const detect = async () => {
      try {
        ...
        if (found) { setSelectedCountry(found); toast.success(`Regi├úo: ${found.name}`, { duration: 2000 }) }
      } catch {}
    }
    detect()
  }, [])
  ...
  const handleOpenPreOrder = (p: Product) => {
    if (!requireAct('fazer uma pr├®-compra')) return
  ...
  const handlePreOrderSubmit = async () => {
    ...
    try {
      ...
      await supabase.rpc('create_notification', {
        p_user_id: selectedProduct.user_id, p_type: 'pre_order', p_title: 'Nova Pr├®-Compra',
      ...
      toast.success('Pr├®-compra registada com sucesso.')
      setModalOpen(false)
      setSelectedProduct(null)
    } catch { toast.error('Erro ao processar pr├®-compra') }
  ...
  return (
    <div style={{ minHeight:'100vh', background: T.canvas, fontFamily:"'DM Sans', system-ui, sans-serif" }}>
      ...
      {/* ÔòÉÔòÉÔòÉ LIVE TICKER ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ */}
      <LiveTicker products={products}/>

      {/* ÔòÉÔòÉÔòÉ HEADER ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ */}
      <header style={{
        ...
        <div style={{ maxWidth:1320, margin:'0 auto', padding:'0 20px', height:62, display:'flex', alignItems:'center', justifyContent:'space-between', gap:16 }}>
          ...
          {/* Search bar ÔÇö visible only sm and above (ÔëÑ 640px) */}
          <div
            style={{
          ...
          >
            ...
            <span style={{ marginLeft:'auto', fontSize:10, color: T.faint, padding:'2px 7px', borderRadius:6, border:`1px solid ${T.rule}`, fontWeight:600 }}>ÔîÿK</span>
          </div>

          {/* Search icon ÔÇö visible only below sm (< 640px) */}
          <button
            style={{
        ...
        {mobileMenuOpen && (
          <div style={{
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <span style={{ fontSize: 13, fontWeight: 700, color: T.ink }}>Regi├úo</span>
              <CountrySelector selectedCountry={selectedCountry} onCountryChange={(c) => { setSelectedCountry(c); toast.success(`${c.flag} ${c.name}`) }}/>
            </div>
            {isAdmin && (
              <button
      ...
      {/* ÔòÉÔòÉÔòÉ CATEGORY FILTERS ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ */}
      <section style={{
        background: T.white,
        borderBottom: `1px solid ${T.rule}`,
        padding: '14px 0',
      ...
      {/* ÔòÉÔòÉÔòÉ PRODUCT GRID ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ */}
        ...
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:28, flexWrap:'wrap', gap:12 }}>
          <div>
            ...
            <p style={{ fontSize:12, color: T.faint, marginTop:4, fontWeight:500 }}>
              {filteredProducts.length} listings ┬À ordenados por relev├óncia
            </p>
          </div>
          <div style={{ display:'flex', alignItems:'center', gap:8 }}>
        ...
        {!loading && filteredProducts.length === 0 && (
          <div style={{ display:'flex', flexDirection:'column', alignItems:'center', padding:'100px 20px', textAlign:'center' }}>
            ...
            <p style={{ fontSize:13, color: T.faint, maxWidth:320, lineHeight:1.65 }}>
              Os primeiros fornecedores est├úo a ser integrados. Volte em breve.
            </p>
          </div>
        )}
      </main>

      {/* ÔòÉÔòÉÔòÉ PRE-ORDER MODAL ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ */}
            ...
            <div style={{ display:'flex', alignItems:'center', gap:12 }}>
              ...
              <div>
                ...
                <p style={{ fontSize:12, color: T.faint, margin:0, marginTop:1 }}>
                  {selectedProduct?.product_type} ┬À {selectedProduct?.farmer_name}
                </p>
              </div>
            </div>
          </div>
          ...
          <div style={{ padding:'20px 24px', background: T.canvas, maxHeight:'60vh', overflowY:'auto', display:'flex', flexDirection:'column', gap:14 }}>
            ...
            <div style={{ display:'flex', gap:11, padding:'11px 14px', borderRadius:12, background: T.white, border:`1px solid ${T.rule}` }}>
              ...
              <p style={{ fontSize:12, color: T.muted, lineHeight:1.6, margin:0 }}>
                Esta ├® uma demonstra├º├úo de interesse. O fornecedor confirmar├í disponibilidade de volume.
              </p>
            </div>
            ...
            <div style={{ display:'flex', flexDirection:'column', gap:6 }}>
              <label style={{ fontSize:12, fontWeight:700, color: T.ink, display:'flex', alignItems:'center', gap:8 }}>
                Quantidade (kg)
                <span style={{ fontSize:10, fontWeight:700, padding:'2px 7px', borderRadius:5, background: T.g50, color: T.g600, border:`1px solid ${T.gBorder}` }}>Obrigat├│rio</span>
              </label>
              <input
                type="number"
              ...
              <p style={{ fontSize:11, color: T.faint, display:'flex', alignItems:'center', gap:5 }}>
                ...
                Dispon├¡vel: <strong style={{ color: T.g600 }}>{selectedProduct?.quantity.toLocaleString()} kg</strong>
              </p>
            </div>
            ...
            <div style={{ padding:'14px 16px', borderRadius:12, background: T.white, border:`1px solid ${T.rule}` }}>
              ...
              {[
                ...
                { label: 'Log├¡stica (7.8%)', val: fmt(orderData.quantity * (selectedProduct?.price||0) * TAX) },
              ].map(row => (
      ...
      {/* ÔöÇÔöÇ Global keyframes & utility styles ÔöÇÔöÇ */}
      <style>{`
